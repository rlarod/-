...
/* =========================================================================
 * [5] 문서끼리 거는 .md 링크 — 깨진 것이 늘지 않는다
 * -------------------------------------------------------------------------
 * 2026-08-27 실측 — 깨진 링크 1건.
 *   docs/운영기록/집에서-이어받기-2026-08-26.md:4
 *     "회차 시작 지침은 `docs/진행상태.md` 입니다"
 *   실제 위치는 docs/운영기록/진행상태.md 입니다.
 *   ⚠ 이건 발견입니다. 문서 담당이 고칠 일이고, 기록팀은 고치지 않습니다.
 *     고쳐지면 이 숫자를 0 으로 내리세요.
 * ========================================================================= */
절("[5] 문서가 거는 .md 링크가 깨진 것이 늘지 않는다");
{
  const 알려진깨짐 = 1;   /* 위 주석 참조 */
