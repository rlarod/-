...
(function () {
   ...
   * ------------------------------------------------ */
  function boot() {
    const modules = ["Chart", "OrderBook", "RecentTrades", "OrderbookTabs", "MarketWar", "OrderPressureBar", "Trading", "SupabaseSync", "TradeHistory", "Leaderboard", "Chat", "TradeEventsChat", "Admin", "Board", "MyPage", "SymbolSelector", "NoticeBoard", "TickerBoard", "PageNav", "UI", "WS"];
