...
(function () {
   ...
   * ------------------------------------------------ */
  function boot() {
    const modules = ["Chart", "OrderBook", "RecentTrades", "MarketWar", "Trading", "SupabaseSync", "TradeHistory", "Leaderboard", "Chat", "TradeEventsChat", "Admin", "Board", "MyPage", "SymbolSelector", "PageNav", "UI", "WS"];
