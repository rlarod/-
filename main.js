...
(function () {
   ...
   * ------------------------------------------------ */
  function boot() {
    const modules = ["Chart", "OrderBook", "OrderbookPriceArrow", "OrderbookMarkPrice", "RecentTrades", "OrderbookTabs", "MarketWar", "OrderPressureBar", "Trading", "OrderInfoPanel", "SupabaseSync", "TradeHistory", "Leaderboard", "Chat", "TradeEventsChat", "Admin", "Board", "MyPage", "SymbolSelector", "Rank", "NoticeBoard", "UserPanel", "TickerBoard", "PageNav", "UI", "QtyPriceOrder", "AmiTalkOrderPanel", "OrderbookClickOrder", "WS"];
